...
TifPath = r"/home/neaucs2/usr/ttt/Unet/unet-pytorch-main/VOCdevkit/VOC2007/SegmentationClass"  # 加载待预测的遥感大图路径
#ResultPath = r"/home/neaucs2/usr/ttt/Unet/unet-pytorch-main/img_out1/0906-3.tif"  # 预测完成后的遥感大图存储路径
ResultPath = r"/home/neaucs2/usr/ttt/pspnet/pspnet-pytorch-master/out1"  
...
model   = PSPNet(num_classes=4, backbone=backbone, pretrained=False, aux_branch=False)
...
for img_name in tqdm(img_names):
    ...
    for i in range(len(TifArray)):
        for j in range(len(TifArray[0])):
            ...
            model.load_state_dict(torch.load(r"/home/neaucs2/usr/ttt/pspnet/pspnet-pytorch-master/logs/47-miou-jpg/best_epoch_weights.pth", map_location='cuda:0'), strict=False)  # 导入训练完成后的模型文件
