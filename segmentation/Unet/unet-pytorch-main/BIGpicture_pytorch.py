...
ResultPath = r"/home/neaucs2/usr/ttt/Unet/unet-pytorch-main/img_out1"  
...
model   = Unet(num_classes=4, backbone=backbone)
...
for img_name in tqdm(img_names):
    ...
    for i in range(len(TifArray)):
        for j in range(len(TifArray[0])):
            ...
            model.load_state_dict(torch.load(r"/home/neaucs2/usr/ttt/Unet/unet-pytorch-main/logs/83-miou-jpg/best_epoch_weights.pth", map_location='cuda:0'))  # 导入训练完成后的模型文件
